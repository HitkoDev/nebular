...
const routes: Route[] = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./datepicker-with-format/datepicker-with-format.module').then((m) => m.DatepickerWithFormatModule),
      },
      {
        path: 'timepicker',
      ...
      },
      {
        ...
        loadChildren: () =>
          import('./oauth2-password/oauth2-password.module').then((m) => m.OAuth2PasswordPlaygroundModule),
      },
      {
        path: 'tree-grid',
